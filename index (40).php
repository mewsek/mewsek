...
define('CAMPAIGN_ID', "8e1a57cc4cd8b62880c3bb59ccfb954b");
define('REQUEST_LIVE_TIME', 3600);
define('ENC_KEY', '86f78dfee0d5281fd4eeeefc7aea21da');
define('MP_PARAM_NAME', '__ef__id');
define('NOT_FOUND_TEXT', '<h1>Page not found</h1>');
define('CHECK_MCPROXY', 0);
define('CHECK_MCPROXY_PARAM', '1d08794985c84b1cb2427be0a1a654a4');
define('CHECK_MCPROXY_VALUE', 'd3e96c2bf93f288451a9505bdaef6b5fe3ee624cb57eaafd5680631eaf6eae3a');
...
function sendRequest($data, $path = 'index') {
  ...
  $data_to_post = array("cmp"=> CAMPAIGN_ID,"headers" => $data,"adapi" => '2.2', "sv" => '22793.3');
